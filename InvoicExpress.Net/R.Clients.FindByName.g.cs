...
// https://invoicexpress.com/api/clients/find-by-name
namespace InvoicExpress.Net.R.Clients.FindByName
{
	/// <remarks/>
	...
	public partial class client {
	    ...
	    private string open_account_linkField;
	    ...
	    /// <remarks/>
	    public string open_account_link {
	        get {
	            return this.open_account_linkField;
	        }
	        set {
	            this.open_account_linkField = value;
	        }
	    }
	    /// <remarks/>
