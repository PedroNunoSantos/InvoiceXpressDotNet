...
// https://invoicexpress.com/api/simplified-invoices/list
namespace InvoicExpress.Net.R.SimplifiedInvoices.List
{
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class simplified_invoices {
	    private simplified_invoicesSimplified_invoice simplified_invoiceField;
	    private string typeField;
	    /// <remarks/>
	    public simplified_invoicesSimplified_invoice simplified_invoice {
	        get {
	            return this.simplified_invoiceField;
	        }
	        set {
	            this.simplified_invoiceField = value;
	        }
	    }
	    /// <remarks/>
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class simplified_invoicesSimplified_invoice {
	    private string idField;
	    private string statusField;
	    private bool archivedField;
	    private string typeField;
	    private uint sequence_numberField;
	    ...
	    private simplified_invoicesSimplified_invoiceClient clientField;
	    private string currencyField;
	    private simplified_invoicesSimplified_invoiceItems itemsField;
	    ...
	    /// <remarks/>
	    public simplified_invoicesSimplified_invoiceClient client {
	        get {
	    ...
	    /// <remarks/>
	    public simplified_invoicesSimplified_invoiceItems items {
	        get {
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class simplified_invoicesSimplified_invoiceClient {
	    private string idField;
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class simplified_invoicesSimplified_invoiceItems {
	    private simplified_invoicesSimplified_invoiceItemsItem itemField;
	    private string typeField;
	    /// <remarks/>
	    public simplified_invoicesSimplified_invoiceItemsItem item {
	        get {
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class simplified_invoicesSimplified_invoiceItemsItem {
	    private string nameField;
	    private string descriptionField;
	    private decimal unit_priceField;
	    private string unitField;
	    private decimal quantityField;
	    private simplified_invoicesSimplified_invoiceItemsItemTax taxField;
	    private decimal discountField;
	    ...
	    /// <remarks/>
	    public simplified_invoicesSimplified_invoiceItemsItemTax tax {
	        get {
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class simplified_invoicesSimplified_invoiceItemsItemTax {
	    private string nameField;
