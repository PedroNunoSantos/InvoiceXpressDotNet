...
// https://invoicexpress.com/api/credit-notes/list
namespace InvoicExpress.Net.R.CreditNotes.List
{
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class credit_notes {
	    private credit_notesCredit_note credit_noteField;
	    private string typeField;
	    /// <remarks/>
	    public credit_notesCredit_note credit_note {
	        get {
	            return this.credit_noteField;
	        }
	        set {
	            this.credit_noteField = value;
	        }
	    }
	    /// <remarks/>
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class credit_notesCredit_note {
	    ...
	    private credit_notesCredit_noteClient clientField;
	    private string currencyField;
	    private credit_notesCredit_noteItems itemsField;
	    ...
	    /// <remarks/>
	    public credit_notesCredit_noteClient client {
	        get {
	    ...
	    /// <remarks/>
	    public credit_notesCredit_noteItems items {
	        get {
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class credit_notesCredit_noteClient {
	    private string idField;
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class credit_notesCredit_noteItems {
	    private credit_notesCredit_noteItemsItem itemField;
	    private string typeField;
	    /// <remarks/>
	    public credit_notesCredit_noteItemsItem item {
	        get {
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class credit_notesCredit_noteItemsItem {
	    private string nameField;
	    private string descriptionField;
	    private decimal unit_priceField;
	    private string unitField;
	    private decimal quantityField;
	    private credit_notesCredit_noteItemsItemTax taxField;
	    private decimal discountField;
	    ...
	    /// <remarks/>
	    public credit_notesCredit_noteItemsItemTax tax {
	        get {
	...
	/// <remarks/>
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
	public partial class credit_notesCredit_noteItemsItemTax {
	    private string nameField;
