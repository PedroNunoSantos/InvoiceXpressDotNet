...
namespace InvoiceXpressDotNet
{
	public static partial class InvoiceExpress
    {
		...
		public static class Invoices
		{
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_Get(string apiKey, string accountName, int invoiceId)
			{
			...
			{
				string xmlResult = Rest_Get(apiKey, accountName, invoiceId);
			    return xmlResult.DeserializeXml<InvoiceDto>();
			}
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_Update(string apiKey, string accountName, int invoiceId, string inputData)
			{
				string url = string.Format("https://{1}.app.invoicexpress.com/invoices/{2}.xml?api_key={0}", apiKey, accountName, invoiceId);
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_ChangeState(string apiKey, string accountName, int invoiceId, string inputData)
			{
			...
			{
				string xmlResult = Rest_ChangeState(apiKey, accountName, invoiceId, inputData.XmlSerializeToString());
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_EmailInvoice(string apiKey, string accountName, int invoiceId, string inputData)
			{
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_RelatedDocuments(string apiKey, string accountName, int invoiceId)
			{
			...
			{
				string xmlResult = Rest_RelatedDocuments(apiKey, accountName, invoiceId);
			    return xmlResult.DeserializeXml<InvoicesDto>();
			}
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_Pdf(string apiKey, string accountName, int invoiceId)
			{
			...
			{
				string xmlResult = Rest_Pdf(apiKey, accountName, invoiceId);
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_Archive(string apiKey, string accountName, string documentType, int documentId)
			{
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_Unarchive(string apiKey, string accountName, string documentType, int documentId)
			{
			...
			/// </summary>
			[EditorBrowsableAttribute(EditorBrowsableState.Never)]
			public static string Rest_PartialPayment(string apiKey, string accountName, int documentId, string inputData)
			{
			...
			{
				string xmlResult = Rest_PartialPayment(apiKey, accountName, documentId, inputData.XmlSerializeToString());
